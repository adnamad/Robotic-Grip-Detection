...
def rgb2array(data_path, desired_size=None, expand=False, hwc=True, show=False):
...
def depth2array(
    data_path, desired_size=None, expand=False, hwc=True, depth_scale=1e-3, show=False
):
